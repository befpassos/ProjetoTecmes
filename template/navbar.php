...
<ul id="slide-out" class="sidenav">
    ...
    <li><a href="/ProjetoTecmes/views/ordemProducao.php"><i class="material-icons">add_circle</i>Painel Pedidos</a></li>
    <li><a href="/ProjetoTecmes/views/produtos.php"><i class="material-icons">widgets</i>Produtos</a></li>
    <li><a href="#!"><i class="material-icons">assignment</i>Produção</a></li>
    <li><a href="#!"><i class="material-icons">show_chart</i>Vendas</a></li>
